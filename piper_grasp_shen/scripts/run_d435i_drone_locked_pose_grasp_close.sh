...
export PIPER_GRASP_PREVIOUS_REPORT_FILE="${PROJECT_DIR}/runtime/drone_grasp/approach25_report.yaml"
...
exec "${PROJECT_DIR}/scripts/run_d435i_locked_pose_grasp_close.sh" "$@"
